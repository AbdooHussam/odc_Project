              ...
              child: Row(
                ...
                children: [
                  SizedBox(
                      ...
                      child: AutoSizeText(widget.answer_1!,
          ...
          Container(
              ...
              child: Row(
                ...
                children: [
                  SizedBox(
                      width: MediaQuery.of(context).size.width * .5,
                      child: AutoSizeText(widget.answer_2!,
                          maxLines: 3, style: TextStyle(fontSize: 15))),
                  Radio(
                    value: 2,
                    activeColor: Color(0xFFFF6600),
          ...
          Container(
              ...
              child: Row(
                ...
                children: [
                  SizedBox(
                    width: MediaQuery.of(context).size.width * .5,
                    child: AutoSizeText(widget.answer_3!,
                        maxLines: 3, style: TextStyle(fontSize: 15)),
                  ),
                  Radio(
                    value: 3,
          ...
          Container(
              ...
              child: Row(
                ...
                children: [
                  SizedBox(
                      width: MediaQuery.of(context).size.width * .5,
                      child: AutoSizeText(widget.answer_4!,
                          maxLines: 3, style: TextStyle(fontSize: 15))),
                  Radio(
                    value: 4,
                    activeColor: Color(0xFFFF6600),
          ...
          Align(
            ...
            child: ElevatedButton(
              onPressed: () async {
                ...
                print("${getExam.currentQuestion}@@@@@@@@@@@@@@@@@@@@@@@");
                print("${getExam.examCard.length}@@@@@@@@@@@@@@@@@@@@@@");
                print(getExam.userAnswer);
                print(getExam.courseCode);
                if (getExam.nextQ == false) {
